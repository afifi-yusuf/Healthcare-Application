...
//Servlet for editing a patient.
@WebServlet("/runeditpatient.html")
public class EditResultServlet extends HttpServlet
{
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        String searchresult = model.editPatient(id, firstName, lastName, dob, dod, ssn, drivers, passport, prefix, suffix, maiden, marital, race, ethnicity, gender, birthplace, address, city, state, zip);
